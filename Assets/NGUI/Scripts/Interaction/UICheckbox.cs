...
public class UICheckbox : MonoBehaviour
{
	...
	public bool invertSpriteBehavior = false;
	/// <summary>
	/// Sprite that's visible when the 'isChecked' status is 'true'.
	/// </summary>

	public UISprite checkSprite;
	public UISprite unCheckSprite;
	/// <summary>
	...
	///<summary>
	///Tell from outside to check or uncheck  
	///</summary>
	public void CheckIt(){this.OnClick();}
	...
	protected virtual void OnClick () { if (enabled) isChecked = !isChecked; }
		...
		else if (mChecked != state)
		{
			...
			if(unCheckSprite != null)
			{
				...
				if(!invertSpriteBehavior)
					...
					c.a = mChecked ? 1f : 0f;
				TweenColor.Begin(unCheckSprite.gameObject, 0.05f, c);
			}
	...
	private void SetSpriteAlpha(bool state)
	{
		if(invertSpriteBehavior)
			if (checkSprite != null) checkSprite.alpha = state ? 0f : 1f;
		else
