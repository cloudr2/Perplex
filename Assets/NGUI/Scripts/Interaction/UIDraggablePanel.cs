...
public class UIDraggablePanel : IgnoreTimeScale
{
	...
	public string functionJumpingName = "OnJumpingBack";
	
	public string functionPressName = "OnPressPanel";
	...
	public bool RestrictWithinBounds (bool instant)
	{
		...
		if (constraint.magnitude > 0.001f)
		{
			...
			else
			{
				...
				eventReceiver.SendMessage(functionJumpingName, constraint, SendMessageOptions.DontRequireReceiver);
	...
	public void Press (bool pressed)
	{
		...
		eventReceiver.SendMessage(functionPressName, pressed, SendMessageOptions.DontRequireReceiver);
	}
