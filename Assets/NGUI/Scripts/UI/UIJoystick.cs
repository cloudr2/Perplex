...
public delegate void JoystickHandler(Vector2 position);

[AddComponentMenu("NGUI/Interaction/Drag Object")]
public class UIJoystick : MonoBehaviour {
	
	public event JoystickHandler OnJoystickDrag;
	public event JoystickHandler OnJoystickReset;
	...
	void ResetJoystick () {
		...
		if(OnJoystickDrag != null)
			OnJoystickDrag(position);
		if(OnJoystickReset != null)
			OnJoystickReset(position);
	}
